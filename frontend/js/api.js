...
const companyAPI = {
  getProfile: () => apiRequest('GET', '/api/company/profile'),
  updateProfile: (data) => apiRequest('PUT', '/api/company/profile', data),
  getJobs: () => apiRequest('GET', '/api/company/jobs'),
  createJob: (data) => apiRequest('POST', '/api/company/jobs', data),
  updateJob: (id, data) => apiRequest('PUT', '/api/company/jobs/' + id, data),
  deleteJob: (id) => apiRequest('DELETE', '/api/company/jobs/' + id),
  getApplicants: (jobId) => apiRequest('GET', '/api/company/jobs/' + jobId + '/applicants'),
  updateApplicantStatus: (appId, status) => apiRequest('PUT', '/api/company/applicants/' + appId + '/status', { status }),
  getStats: () => apiRequest('GET', '/api/company/stats'),
};
