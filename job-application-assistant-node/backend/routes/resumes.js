...
const { sendResumeCreatedEmail } = require('../email');
...
router.post('/create', async (req, res) => {
    try {
        ...
        let emailSent = false;
        try {
            emailSent = await sendResumeCreatedEmail({
            ...
            console.error('Resume saved but email delivery failed:', emailError.message);
        }
